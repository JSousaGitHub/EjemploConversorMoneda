...
public class MonedasController : Controller {
    ...
    public async Task<IActionResult> Create([Bind("Id,Nombre,Codigo,Simbolo")] Moneda moneda) {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Codigo,Simbolo")] Moneda moneda) {
        if(id != moneda.Id) {
            return NotFound();
        }
